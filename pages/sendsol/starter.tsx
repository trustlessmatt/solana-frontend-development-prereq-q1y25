...
const Starter = () => {
  ...
  const handleSend = async () => {
    ...
    const txInfo = {
      feePayer: publicKey, // tx fee payer is the user
      blockhash: blockhash, // a recent blockhash
      lastValidBlockHeight: lastValidBlockHeight, // the last block that the chain can advance to before tx is expired
    };

    const tx = new web3.Transaction(txInfo);
  ...
  // reused from first starter page
  useEffect(() => {
    const getInfo = async () => {
